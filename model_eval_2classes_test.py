...
model_state_dict=torch.load('/home/xuzhengyang/code/vig_model_2classes_epoch_2023-06-29_08_52_17.pkl')
...
h5_path='/home/data/xuzhengyang/ki67/ground_truth_2classes_new/train/4.h5'
...
label_coordinates=peak_local_max(class_heat_map[1], min_distance=6,  exclude_border=6 // 2)
...
full_mask=(full_node_label==9)
full_mask=full_mask.reshape(B,1,num_node)
full_mask=torch.from_numpy(full_mask).cuda()
...
# 计算余弦相似度，得到维度为(8, 1024, 1024),同时也是平均cell均值和其他所有点的cos相似度
...
store_name='/home/xuzhengyang/code/vig_pytorch/result/4_epoch_2023-06-29_08_52_17.h5'
...
# cv2.imwrite("/home/xuzhengyang/code/vig_pytorch/result/21_image_with_points_2023-06-26_22_47_23_0.5.jpg", image)
